...
# 1. 頁面配置 (RWD 原則)
st.set_page_config(page_title="MyMoto99 v13.1", page_icon="🛵", layout="centered")
...
def edit_dialog(index, row_data):
    ...
    with st.form("edit_form"):
        ...
        if st.form_submit_button("💾 確認更新", use_container_width=True):
            ...
            df.loc[index, "里程"] = f_km
            df.loc[index, "金額"] = f_amt
            df.loc[index, "細目"] = f"{f_type}/{calc_L}L"
